...
export const CartItem = () => {
  ...
  return (
    <>
      <h2 className={`${style.good_title} ${style.title} D--1-24 T--1-12 S--1-4`}>Apple iPhone 11 Pro Max 64GB Gold (iMT9G2FS/A)</h2>
      <div className={`${style.good_images} S--1-4 T--1-7 D--1-11`}>
        <img src={img1} alt="main-img" className={`${style.main_img} D--4-12 S--1-4 T--3-6`} />
        <div className={`${style.secondary_images} S--1-4 T--1-2`}>
          <div className={`${style.good_wrapper} D--1-1`}>
            <img src={img2} alt="1" className={`${style.secondary_img} D--1-1`} />
          </div>
          <div className={`${style.good_wrapper} D--1-1`}>
            <img src={img3} alt="1" className={`${style.secondary_img} D--1-1`} />
          </div>
          <div className={`${style.good_wrapper} D--1-1`}>
            <img src={img4} alt="1" className={`${style.secondary_img} D--1-1`} />
          </div>
          <div className={`${style.good_wrapper} D--1-1`}>
            <img src={img5} alt="1" className={`${style.secondary_img} D--1-1`} />
          </div>
          <div className={`${style.good_availableColors} D--14-17`}>
          </div>
        </div>
      </div>
      ...
      <div className={`${style.good_options} S--1-4 T--8-12 D--14-20`}>
        <div className={`${style.good_colors}`}>
          <div className={`${style.good_colors__bar}`}>
            ...
            <div className={`${style.good_color}`}>
              <button autoFocus className={`${style.color_button} ${style.button_1}`}></button>
            </div>
            <div className={`${style.good_color}`}>
              <button className={`${style.color_button} ${style.button_2}`}></button>
            </div>
            <div className={`${style.good_color}`}>
              <button className={`${style.color_button} ${style.button_3}`}></button>
            </div>
            <div className={`${style.good_color}`}>
              <button className={`${style.color_button} ${style.button_4}`}></button>
            </div>
          </div>
        ...
        <div className={`${style.good_capacity} S--1-4 T--8-12 D--14-20`}>
          <p>Select capacity</p>
          <div>
            <button autoFocus className={`${style.capacity_selector}`}>64 GB</button>
        ...
        <div className={`${style.good_prices} S--1-4 T--8-12 D--14-20`}>
          <p className={`${style.good_prices_current}`}>
            $799
          </p>
          <p className={`${style.good_prices_previous}`}>
            $1199
          </p>
        </div>
      ...
      <div className={`${style.good_about} S--1-4 T--1-12 D--1-12`}>
        <h3 className={`${style.good_about__title} ${style.title}`}>
          About
        </h3>
        ...
        <p className={`${style.about_content}`}>
          A transformative triple‑camera system that adds tons of capability without complexity. <br /> <br />
      ...
      <div className={`${style.good_specs} S--1-4 T--1-12 D--13-24`}>
        ...
        <div className={`${style.good_spec}`}>
          <p className={`${style.spec_title} ${style.text}`}>
            Screen
          </p>
